...
let settingsDark =
    getComputedStyle(document.documentElement).getPropertyValue('--spice-dark') == '#010101';
...
async function songchange() {
    ...
    if (album_uri && !album_uri.includes('spotify:show')) {
        ...
        album_date = album_date.toLocaleString(
            'default',
            album_date > recent_date ? { year: 'numeric', month: 'short' } : { year: 'numeric' }
        );
        nearArtistSpanText = `
            <span>
                <span draggable="true">
